...
})()(
  {
    1: [
      function (require, module, exports) {
        ...
        const renderSelector = (selectorToken) => {
          ...
          for (const token of tokens) {
            ...
            if (token.type === 'universalSelector') {
              ...
              if (token.parameters && token.parameters.length) {
                part +=
                  '(' + token.parameters.map(escapeValue).join(', ') + ')';
              }
      ...
      function (require, module, exports) {
        ...
        var _default = () => {
          const parse = (selector) => {
            const parser = new _nearley.Parser(
              _grammar.default.ParserRules,
              _grammar.default.ParserStart
            );
      ...
      function (require, module, exports) {
        ...
        (function () {
          ...
          const concatUsingCombinator = (d) => {
            return (Array.isArray(d[0]) ? d[0] : [d[0]])
              .concat({
          ...
          var grammar = {
            ...
            ParserRules: [
              ...
              {
                name: 'selectorBody$ebnf$3',
                symbols: ['selectorBody$ebnf$3', 'classSelector'],
                postprocess: function arrpush(d) {
                  return d[0].concat([d[1]]);
                },
              },
              {
                name: 'selectorBody$ebnf$4',
                symbols: [],
              },
              {
                name: 'selectorBody$ebnf$4',
                symbols: ['selectorBody$ebnf$4', 'attributeValueSelector'],
                postprocess: function arrpush(d) {
                  return d[0].concat([d[1]]);
                },
              },
              {
                name: 'selectorBody$ebnf$5',
                symbols: [],
              },
              {
                name: 'selectorBody$ebnf$5',
                symbols: ['selectorBody$ebnf$5', 'attributePresenceSelector'],
                postprocess: function arrpush(d) {
                  return d[0].concat([d[1]]);
                },
              },
              {
                name: 'selectorBody$ebnf$6',
                symbols: [],
              },
              {
                name: 'selectorBody$ebnf$6',
                symbols: ['selectorBody$ebnf$6', 'pseudoClassSelector'],
                postprocess: function arrpush(d) {
                  return d[0].concat([d[1]]);
                },
              },
              {
                name: 'selectorBody$ebnf$7',
              ...
              },
              {
                ...
                postprocess: (d, i, reject) => {
                  const selectors = flatten(d);
                  if (!selectors.length) return reject;
                  return selectors;
                },
              },
              {
                name: 'selectorBody$ebnf$8',
                symbols: ['idSelector'],
                postprocess: id,
              },
              {
              ...
              {
                name: 'selectorBody$ebnf$9',
                symbols: [],
              },
              {
                name: 'selectorBody$ebnf$9',
                symbols: ['selectorBody$ebnf$9', 'classSelector'],
                postprocess: function arrpush(d) {
                  return d[0].concat([d[1]]);
                },
              },
              {
                name: 'selectorBody$ebnf$10',
                symbols: [],
              },
              {
                name: 'selectorBody$ebnf$10',
                symbols: ['selectorBody$ebnf$10', 'attributeValueSelector'],
                postprocess: function arrpush(d) {
                  return d[0].concat([d[1]]);
                },
              },
              {
                name: 'selectorBody$ebnf$11',
                symbols: [],
              },
              {
                name: 'selectorBody$ebnf$11',
                symbols: ['selectorBody$ebnf$11', 'attributePresenceSelector'],
                postprocess: function arrpush(d) {
                  return d[0].concat([d[1]]);
                },
              },
              {
                name: 'selectorBody$ebnf$12',
                symbols: [],
              },
              {
                name: 'selectorBody$ebnf$12',
                symbols: ['selectorBody$ebnf$12', 'pseudoClassSelector'],
                postprocess: function arrpush(d) {
                  return d[0].concat([d[1]]);
                },
              },
              {
                name: 'selectorBody$ebnf$13',
                symbols: ['pseudoElementSelector'],
                postprocess: id,
              },
              {
              ...
              },
              {
                ...
                symbols: [
                  ...
                  'selectorBody$ebnf$8',
                  'selectorBody$ebnf$9',
                  'selectorBody$ebnf$10',
                  'selectorBody$ebnf$11',
                  'selectorBody$ebnf$12',
                  'selectorBody$ebnf$13',
                ],
                postprocess: flatten,
              },
              {
              ...
              },
              {
                ...
                postprocess: (d) => (d[0] || '') + d[1] + d[2].join(''),
              },
              {
              ...
              {
                name: 'attributeName$ebnf$1',
                symbols: ['attributeName$ebnf$1', /[_a-zA-Z0-9-]/],
                postprocess: function arrpush(d) {
                  return d[0].concat([d[1]]);
                },
              },
              {
                name: 'attributeName',
                symbols: [/[_a-zA-Z]/, 'attributeName$ebnf$1'],
              ...
              {
                name: 'attributeValue',
                symbols: ['unquotedAttributeValue'],
                postprocess: id,
              },
              {
                name: 'attributeValue',
              ...
              {
                name: 'unquotedAttributeValue$ebnf$1',
                symbols: [/[^\[\]"',= ]/],
              },
              {
                name: 'unquotedAttributeValue$ebnf$1',
                symbols: ['unquotedAttributeValue$ebnf$1', /[^\[\]"',= ]/],
                postprocess: function arrpush(d) {
                  return d[0].concat([d[1]]);
                },
              },
              ...
              },
              {
                ...
                symbols: [
                  'pseudoElementSelector$string$1',
    ...
    4: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, 'createGenerator', {
          enumerable: true,
          get: function () {
            return _createGenerator.default;
          },
        });
        ...
        var _createGenerator = _interopRequireDefault(
          require('./createGenerator')
        );
        ...
        window.scalpel = exports;
      },
      { './createGenerator': 1, './createParser': 2 },
    ],
    5: [
      function (require, module, exports) {
